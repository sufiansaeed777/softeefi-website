...
const WebsitesAndApps = () => {
  ...
  useEffect(() => {
    document.title = 'Diamond Standard Websites & Apps | Softeefi';
  ...
  // Diamond Standard theme - Ultimate luxury palette
  const colors = {
    black: '#050505',
    darkBg: '#0a0a0a',
    diamond: '#F0F8FF',  // Pure diamond white with hint of blue
    diamondLight: '#FFFFFF',  // Brilliant white
    diamondBlue: '#E6F3FF',  // Light blue diamond tint
    crystal: '#B9E5FF',  // Crystal blue
    crystalDark: '#87CEEB',  // Deeper crystal
    prismatic: '#DDA0DD',  // Prismatic purple
    prismaticDark: '#9370DB',  // Deep prismatic
    shimmer: '#F5F5DC',  // Pearl shimmer
    white: '#FFFFFF',
    gray: '#888888',
    lightGray: '#CCCCCC',
    luxury: '#4169E1',  // Royal blue
    radiant: '#FF1493'  // Radiant pink accent
  };
  ...
  const services = [
    {
      id: 1,
      icon: <FaCode />,
      title: "Diamond-Class Websites",
      description: "The pinnacle of digital luxury - flawless websites that radiate excellence",
      features: [
        "Responsive Design",
        "Lightning Fast",
        "SEO Optimized",
      ...
      bgGradient: `linear-gradient(135deg, ${colors.diamond}20 0%, ${colors.crystal}20 100%)`
    },
    {
      id: 2,
      icon: <FaShoppingCart />,
      title: "Diamond E-commerce Empires",
      description: "Ultra-luxury marketplaces with unparalleled shopping sophistication",
      features: [
        "Payment Gateways",
      ...
      color: colors.prismatic,
      bgGradient: `linear-gradient(135deg, ${colors.prismatic}20 0%, ${colors.prismaticDark}20 100%)`
    },
    {
      id: 3,
      icon: <BiCodeBlock />,
      title: "Diamond-Tier Applications",
      description: "Flawless software masterpieces engineered for infinite scale",
      features: [
        "Real-time Features",
        "API Integration",
        "Cloud Deployment",
    ...
    },
    {
      id: 4,
      icon: <FaMobile />,
      title: "Diamond Mobile Experiences",
      description: "Revolutionary apps that set the diamond standard for mobile luxury",
      features: [
        "Native Performance",
        "Push Notifications",
        "Offline Support",
      ...
      >
        ...
        >
          ...
          <motion.div 
            ...
            style={{
              ...
              inset: 0,
              backgroundImage: `
                linear-gradient(45deg, ${colors.diamond}20 25%, transparent 25%, transparent 75%, ${colors.crystal}20 75%),
                linear-gradient(-45deg, ${colors.crystal}20 25%, transparent 25%, transparent 75%, ${colors.diamond}20 75%)
              `,
          ...
          {[...Array(20)].map((_, i) => (
            <motion.div
              ...
              style={{
                ...
                borderRadius: '50%',
                background: i % 4 === 0 ? colors.diamond : i % 4 === 1 ? colors.crystal : i % 4 === 2 ? colors.prismatic : colors.luxury,
                opacity: Math.random() * 0.7 + 0.3,
                filter: 'blur(0.5px)',
                boxShadow: `0 0 ${Math.random() * 15 + 5}px ${i % 2 === 0 ? colors.crystal : colors.prismatic}`
              }}
            />
          ))}
        ...
        >
          ...
          >
            ...
            <span style={{ 
              background: `linear-gradient(90deg, ${colors.diamond} 0%, ${colors.crystal} 25%, ${colors.prismatic} 50%, ${colors.crystal} 75%, ${colors.diamond} 100%)`,
              ...
              <FaGem style={{ color: colors.luxury, marginRight: '0.5rem', WebkitTextFillColor: colors.luxury }} />
              Diamond-Standard Brilliance Certified
            </span>
          </motion.div>
          ...
          >
            ...
            <span style={{
              ...
              fontWeight: '700',
              background: `linear-gradient(135deg, ${colors.crystal} 0%, ${colors.prismatic} 50%, ${colors.luxury} 100%)`,
              WebkitBackgroundClip: 'text',
              WebkitTextFillColor: 'transparent'
            }}>
              Websites & Apps
          ...
          >
            ...
            >
              <Link
                ...
                style={{
                  padding: '1.2rem 3rem',
                  background: `linear-gradient(135deg, ${colors.diamond} 0%, ${colors.crystal} 33%, ${colors.prismatic} 66%, ${colors.luxury} 100%)`,
                  color: colors.black,
                  textDecoration: 'none',
                  borderRadius: '50px',
                  fontWeight: '800',
                  ...
                  boxShadow: `0 15px 40px ${colors.crystal}50, inset 0 2px 4px ${colors.diamond}80`,
                ...
                onMouseEnter={(e) => {
                  ...
                  e.currentTarget.style.background = `linear-gradient(135deg, ${colors.luxury} 0%, ${colors.prismatic} 33%, ${colors.crystal} 66%, ${colors.diamond} 100%)`;
                  e.currentTarget.style.boxShadow = `0 20px 50px ${colors.prismatic}60, inset 0 2px 4px ${colors.diamond}80`;
                }}
                onMouseLeave={(e) => {
