...
const WebsitesAndApps = () => {
  ...
  useEffect(() => {
    document.title = 'Platinum Standard Websites & Apps | Softeefi';
  ...
  // Premium theme colors - Platinum palette
  const colors = {
    black: '#0a0a0a',
    darkBg: '#0d0d0d',
    platinum: '#E5E4E2',  // Primary platinum
    platinumLight: '#F4F4F4',  // Light platinum
    platinumDark: '#C0C0C0',  // Dark platinum
    gold: '#FFD700',  // Bright gold for accents
    goldDark: '#FFA500',  // Deep gold
    accent: '#00D4FF',  // Premium blue accent
    accentDark: '#0099CC',  // Darker blue
    white: '#FFFFFF',
    gray: '#888888',
    lightGray: '#CCCCCC',
    success: '#00FF88',  // Success green
    premium: '#FF00FF'  // Premium purple accent
  };
  ...
  const services = [
    {
      id: 1,
      icon: <FaCode />,
      title: "Platinum Business Websites",
      description: "Ultra-premium websites engineered for maximum conversion and brand prestige",
      features: [
        "Responsive Design",
        "Lightning Fast",
        "SEO Optimized",
      ...
      bgGradient: `linear-gradient(135deg, ${colors.platinum}20 0%, ${colors.platinumDark}20 100%)`
    },
    {
      id: 2,
      icon: <FaShoppingCart />,
      title: "Luxury E-commerce Platforms",
      description: "Bespoke online stores delivering world-class shopping experiences",
      features: [
        "Payment Gateways",
      ...
      color: colors.accent,
      bgGradient: `linear-gradient(135deg, ${colors.accent}20 0%, ${colors.accentDark}20 100%)`
    },
    {
      id: 3,
      icon: <BiCodeBlock />,
      title: "Enterprise-Grade Applications",
      description: "Platinum-tier software solutions built for scale and performance",
      features: [
        "Real-time Features",
        "API Integration",
        "Cloud Deployment",
    ...
    },
    {
      id: 4,
      icon: <FaMobile />,
      title: "Award-Winning Mobile Apps",
      description: "Industry-leading apps that redefine mobile excellence",
      features: [
        "Native Performance",
        "Push Notifications",
        "Offline Support",
        ...
        >
          ...
          <motion.div 
            ...
            style={{
              ...
              inset: 0,
              backgroundImage: `
                linear-gradient(${colors.platinum}15 1px, transparent 1px),
                linear-gradient(90deg, ${colors.platinum}15 1px, transparent 1px)
              `,
          ...
          {[...Array(20)].map((_, i) => (
            <motion.div
              ...
              style={{
                ...
                borderRadius: '50%',
                background: i % 3 === 0 ? colors.gold : i % 3 === 1 ? colors.platinum : colors.accent,
        ...
        >
          ...
          >
            ...
            <span style={{ 
              ...
              <FaCrown style={{ color: colors.gold, marginRight: '0.5rem', WebkitTextFillColor: colors.gold }} />
              Platinum-Tier Excellence Guaranteed
            </span>
          </motion.div>
          ...
          >
            ...
            >
              <Link
                ...
                style={{
                  padding: '1.2rem 3rem',
                  background: `linear-gradient(135deg, ${colors.platinum} 0%, ${colors.platinumDark} 50%, ${colors.gold} 100%)`,
                  color: colors.black,
                  textDecoration: 'none',
                  borderRadius: '50px',
                  fontWeight: '800',
                  ...
                  boxShadow: `0 10px 30px ${colors.platinum}30, inset 0 1px 0 ${colors.white}50`,
                  border: `2px solid ${colors.platinum}50`,
                  position: 'relative',
                  overflow: 'hidden'
                }}
                onMouseEnter={(e) => {
                  e.currentTarget.style.transform = 'translateY(-3px)';
                  e.currentTarget.style.background = `linear-gradient(135deg, ${colors.gold} 0%, ${colors.accent} 50%, ${colors.platinum} 100%)`;
                  e.currentTarget.style.boxShadow = `0 15px 40px ${colors.gold}30, inset 0 1px 0 ${colors.white}50`;
                }}
                onMouseLeave={(e) => {
            ...
            >
              <Link
                ...
                style={{
                  padding: '1.2rem 3rem',
                  background: `linear-gradient(135deg, transparent 0%, ${colors.accent}10 100%)`,
                  color: colors.accent,
                  textDecoration: 'none',
                  borderRadius: '50px',
                  fontWeight: '700',
